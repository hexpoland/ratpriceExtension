...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  if (request.greeting == "hello") console.log("Mamy komunikacje z content");
  sendResponse({
    farewell: "goodbye"
  });
});
...
$('td .send').on('click',(e)=>{
  ...
  if(to!=null){
    sendEmail('wolaqu@poczta.onet.pl','wolaqu@poczta.onet.pl','Wycena czesci',body);
  }
})
